...
class CategoriaListView(LoginRequiredMixin, ListView):
    model = Categoria
    template_name = 'platillos/categoria_list.html'
    context_object_name = 'categorias'

class CategoriaCreateView(LoginRequiredMixin, CreateView):
    model = Categoria
    form_class = CategoriaForm
    template_name = 'platillos/categoria_form.html'
    success_url = '/platillos/categorias/'

class CategoriaUpdateView(LoginRequiredMixin, UpdateView):
    model = Categoria
    form_class = CategoriaForm
    template_name = 'platillos/categoria_edit_form.html'
    success_url = '/platillos/categorias/'

class CategoriaDeleteView(LoginRequiredMixin, DeleteView):
    model = Categoria
    template_name = 'platillos/categoria_confirm_delete.html'
    success_url = '/platillos/categorias/'
